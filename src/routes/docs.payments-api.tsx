  ...
  head: () => ({
    meta: [
      { title: "Payment Verification API — Gatekeepr Docs" },
      {
        name: "description",
        content:
          "Public API documentation for verifying payments against Gatekeepr transactions. Endpoint, request body, examples, and responses.",
      },
      { property: "og:title", content: "Payment Verification API — Gatekeepr Docs" },
      {
        property: "og:description",
        content: "Verify partner payments against Gatekeepr transactions via a simple POST endpoint.",
      },
    ],
  }),
